            ...
            <form className="form-horizontal new-lg-form formSubmit" method="post" ref={e => this._formSubmit = e} onSubmit={ this.onSubmitFormLogin } name="myform" noValidate >
              ...
              <div className="form-group">
                <div className="col-xs-12">
                  ...
                  <input autoComplete="off" ref={e => this._passwordInput = e} className="form-control" id="password" name="password" form-valid="str:6:32" type="password" placeholder="Password" />
